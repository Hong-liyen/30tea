$(document).ready(function () {
	...
	var swiper = new Swiper(".index_store .thumbsSlider", {
		spaceBetween: 10,
		slidesPerView: 4,
	});
	var swiper2 = new Swiper(".store-view .store_box", {
		effect: 'fade',
		fadeEffect: {
			crossFade: true
		},
	...
	var swiper = new Swiper(".index_prd .thumbsSlider_prd", {
		spaceBetween: 10,
		slidesPerView: 5,
		freeMode: true,
	...
	var swiper2 = new Swiper(".index_prd .product_box", {
		effect: 'fade',
		loop: true,
		fadeEffect: {
			crossFade: true
